  ...
  log: (info, callback) => {
    ...
    if (ioInstance) {
      ...
      const isPublicMilestone =
        ...
        message.includes("CycleStarted") ||
        message.includes("Rebalanced") ||
        message.includes("BufferAdjusted") ||
        message.includes("MovedToReserve") ||
        message.includes("PaydayTriggered") ||
        message.includes("NoActionNeeded") ||
        message.includes("---------------------------------------------------");
